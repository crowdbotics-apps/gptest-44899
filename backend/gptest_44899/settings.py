"""
Django settings for gptest_44899 project.
...
ROOT_URLCONF = 'gptest_44899.urls'
...
WSGI_APPLICATION = 'gptest_44899.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gptest_44899 API",
    "DESCRIPTION": "API documentation for gptest_44899 App",
    "VERSION": "v1",
}
